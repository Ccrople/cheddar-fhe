"""BERT-Tiny (google/bert_uncased_L-2_H-128_A-2) -> f32 blobs in this tree's layout.
...
2 by hand.
    ...
    python export.py <out_dir> [--tokens 128] [--model google/bert_uncased_L-2_H-128_A-2]
...
Conventions are `reference/scripts/export_bert.py`'s (BERT-Base), so a
